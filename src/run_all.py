...
### Process Radon data 
from etl.proc_radon import proc_radon

data =  proc_radon(df_radon)

### Run pymc3 hier regression
from models.models_pymc3 import hier_reg_pymc3 as hr_pymc3
...
from models.models_pystan import hier_reg_pystan as hr_stan
